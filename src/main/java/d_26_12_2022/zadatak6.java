...
public class zadatak6 {
    public static void main(String[] args) {
        ...
        double rezultat = konvertujUValutu(vrednost,valuta);
        System.out.println(vrednost + " EUR je " + rezultat + " " + valuta);


    }
    public static double konvertujUValutu (int euro, String valuta){
        double rezultat = 1;
